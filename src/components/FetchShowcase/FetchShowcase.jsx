    ...
    <div className="bg-gray-50 py-32 w-full relative overflow-hidden">
      ...
      <div className="container">
        ...
        <div className="flex flex-col justify-center items-center mb-20 text-center max-w-3xl mx-auto">
          ...
          >
            <span className="text-sm font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">AI检测 · 真伪鉴别</span>
          </motion.div>
          <motion.h2
          ...
          >
            <p>基于LLM的AI生成文本检测系统，快速准确识别AI生成内容</p>
          </motion.div>
        </div>
